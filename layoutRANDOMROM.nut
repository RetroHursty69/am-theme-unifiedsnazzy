...
//Also, a big thank you to Luciano Silva for doing the coding to allow the background image to be randomised.
...
local background = fe.add_artwork("background", 0, 0, flw, flh);
